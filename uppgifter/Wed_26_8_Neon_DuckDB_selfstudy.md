...
connection string for the below to work. You will also have to install DuckDB and possibly numpy.
...
DuckDB's CLI, on your machine (e g in VSCode or the terminal), or a Codespace:
